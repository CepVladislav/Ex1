...
int main()
{
    ...
    std::cout << "500(or less) most active buyers: " << std::endl;
    try
    {
        for_each(v.begin(), v.end(), [&i](DataBase _n)
            {
                i++;
...
//Определить наиболее частых покупателей для рассылки из 500 адресантов. Оценить количество проходов